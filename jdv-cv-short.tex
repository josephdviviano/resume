...
{Research internship supervised by Dr. Yoshua Bengio, focus on machine learning for healthcare.} \\\
...
{1.5-hour course on deep learning for a non-CS audiance.}

\entry
{2019}
{Instructor}
{Brainhack 2019: Deep Learning for Neuroscientists}
{3-hour course on deep learning for a non-CS audiance.}
