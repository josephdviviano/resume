...
{
    \item Development of open-source GFlowNet tools such as \link{https://github.com/gfnorg/torchgfn}{torchgfn}.
    \item ML for Science research with a focus on Biology.
    \item Ongoing project with \link{https://www.amgen.com/}{Amgen} on antibody design.
}
...
{Area Chair}
{Meta Reviewing}
{Paper Adjudication for \link{https://neurips.cc/virtual/2023}{NeurIPS Datasets and Benchmarks Workshop 2023}}
...
\paper{Lahlau S, \textcolor{highlight}{Viviano JD}, Schmidt V. torchgfn: A PyTorch GFlowNet library. arXiv, 2023.}
