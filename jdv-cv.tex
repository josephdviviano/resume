...
\skills
{Neuroscience}
{Self-organized network activity, biomarkers, and brain state identification.} \\\
...
{MSc. Candidate}
{\\\
Dr. Keith Schneider, Schneider Lab, York University}
{
...
{Research Assistant}
{\\\
Dr. Darryl Wilson, Queen's University.}
{
\item Planned and designed a psychophysics experiment in MATLAB.
} \\\

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\sectionheading{SAMPLE SOFTWARE PROJECTS} \\\
%
%\entry
%{2016--2017}
%{xbrain: A tool for predicting cognitive scores from brain activity.}
%{}
%{Code available at \href{https://github.com/josephdviviano/xbrain}{https://github.com/josephdviviano/xbrain}.} \\\
%
%\entry
%{2016}
%{script-it: A platform for BASH pipeline development.}
%{}
%{Code available at \href{https://github.com/josephdviviano/script-it}{https://github.com/josephdviviano/script-it}.} \\\
%
%\entry
%{2014--2017}
%{datman: Automatic management, qc, and analysis of MRI data.}
%{}
%{Code available at \href{https://github.com/TIGRLab/datman}{https://github.com/TIGRLab/datman}.} \\\
%
%\entry
%{2013--2016}
%{epitome: A set of configurable MRI pre-processing modules for custom pipeline development.}
%{}
%{Code available at \href{https://github.com/josephdviviano/epitome}{https://github.com/josephdviviano/epitome}.} \\\
